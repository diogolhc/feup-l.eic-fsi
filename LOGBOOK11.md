...
## Tarefa 1
Ao correr os comandos *openssl x509 -in ca.crt -text -noout* e *openssl rsa -in ca.key -text -noout* obteve-se respetivamente os seguintes *outputs*
...
```
- **Perguntar ao professor** Este certificado é um certicado de CA já que o *subject* e o *issuer* são o mesmo (https://sites.google.com/site/ddmwsst/digital-certificates)
